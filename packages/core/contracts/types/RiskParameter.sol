...
library RiskParameterStorageLib {
    ...
    function read(RiskParameterStorage storage self) internal view returns (RiskParameter memory) {
        ...
        return RiskParameter(
            ...
            SynBook6(
                ...
                UFixed6Lib.from(uint256(slot1 << (256 - 40 - 32 - 48)) >> (256 - 48))
            ),
            ...
            UJumpRateUtilizationCurve6(
                UFixed6.wrap(uint256(   slot1 << (256 - 40 - 32 - 48 - 24)) >> (256 - 24)),
                UFixed6.wrap(uint256(   slot1 << (256 - 40 - 32 - 48 - 24 - 24)) >> (256 - 24)),
                UFixed6.wrap(uint256(   slot1 << (256 - 40 - 32 - 48 - 24 - 24 - 24)) >> (256 - 24)),
                UFixed6.wrap(uint256(   slot1 << (256 - 40 - 32 - 48 - 24 - 24 - 24 - 24)) >> (256 - 24))
            ),

            PController6(
                UFixed6.wrap(uint256(   slot2 << (256 - 48)) >> (256 - 48)),
                Fixed6.wrap(int256(     slot1 << (256 - 40 - 32 - 48 - 24 - 24 - 24 - 24 - 32)) >> (256 - 32)),
            ...
            UFixed6.wrap(uint256(       slot1 << (256 - 40 - 32)) >> (256 - 32))
        );
    }
    ...
    function validateAndStore(
        ...
        uint256 encoded1 =
            uint256(UFixed6.unwrap(newValue.maxLiquidationFee)                  << (256 - 32)) >> (256 - 40 - 32) |
            uint256(newValue.synBook.scale.truncate()                           << (256 - 48)) >> (256 - 40 - 32 - 48) |
            uint256(UFixed6.unwrap(newValue.utilizationCurve.minRate)           << (256 - 24)) >> (256 - 40 - 32 - 48 - 24) |
            uint256(UFixed6.unwrap(newValue.utilizationCurve.maxRate)           << (256 - 24)) >> (256 - 40 - 32 - 48 - 24 - 24) |
            uint256(UFixed6.unwrap(newValue.utilizationCurve.targetRate)        << (256 - 24)) >> (256 - 40 - 32 - 48 - 24 - 24 - 24) |
            uint256(UFixed6.unwrap(newValue.utilizationCurve.targetUtilization) << (256 - 24)) >> (256 - 40 - 32 - 48 - 24 - 24 - 24 - 24) |
            uint256(Fixed6.unwrap(newValue.pController.min)                     << (256 - 32)) >> (256 - 40 - 32 - 48 - 24 - 24 - 24 - 24 - 32);
