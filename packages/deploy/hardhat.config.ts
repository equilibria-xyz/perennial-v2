...
const config = defaultConfig({
  dependencyPaths: [
    ...
    '@perennial/v2-oracle/contracts/stork/StorkFactory.sol',
  ...
  solidityOverrides: {
    ...
    '@perennial/v2-periphery/contracts/MultiInvoker/MultiInvoker_Arbitrum.sol': {
      ...peripheryOverrides['contracts/MultiInvoker/MultiInvoker_Arbitrum.sol'],
    },
    '@perennial/v2-periphery/contracts/MultiInvoker/MultiInvoker_Optimism.sol': {
      ...peripheryOverrides['contracts/MultiInvoker/MultiInvoker_Optimism.sol'],
    },
    '@perennial/v2-periphery/contracts/CollateralAccounts/Controller_Arbitrum.sol': {
      ...peripheryOverrides['contracts/CollateralAccounts/Controller_Arbitrum.sol'],
    },
    '@perennial/v2-periphery/contracts/CollateralAccounts/Controller_Optimism.sol': {
