...
describe('MultiInvokerRollup', () => {
  ...
  describe('#invoke', () => {
    ...
    it('approves market and vault', async () => {
      ...
      let i: Actions = buildApproveTarget({ target: owner.address })
    ...
    describe('#keeper order invoke', () => {
      ...
      it('places a limit order', async () => {
        ...
        console.log(o)
        const txn = user.sendTransaction(invoke(user, multiInvoker, o))
...
export function invoke(user: SignerWithAddress, invoker: MultiInvokerRollup, payload: string): TransactionRequest {
