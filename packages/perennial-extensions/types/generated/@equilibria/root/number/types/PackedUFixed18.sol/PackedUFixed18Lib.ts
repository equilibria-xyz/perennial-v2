...
export interface PackedUFixed18LibInterface extends utils.Interface {
  functions: {
    "MAX()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "MAX"): FunctionFragment;
...
export interface PackedUFixed18Lib extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PackedUFixed18LibInterface;
