...
export interface Fixed18LibInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "MAX" | "MIN" | "NEG_ONE" | "ONE" | "ZERO"
  ): FunctionFragment;
...
export interface Fixed18Lib extends BaseContract {
