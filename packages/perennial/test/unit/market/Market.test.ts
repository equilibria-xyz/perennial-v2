...
describe.only('Market', () => {
  ...
  beforeEach(async () => {
    ...
    await payoffProvider.mock.payoff.withArgs(price).returns(true)
      ...
      describe('positive price market', async () => {
        ...
        context('make position', async () => {
          it.only('opens the position', async () => {
            await dsu.mock.transferFrom.withArgs(user.address, market.address, COLLATERAL).returns(true)
          ...
          it('reverts if can liquidate', async () => {
            ...
            await expect(market.connect(user).openMake(POSITION)).to.be.revertedWith(
        ...
        context('#closeMake', async () => {
          ...
          context('settles first', async () => {
            ...
            it('reverts if underflow', async () => {
              await expect(market.connect(user).closeMake(POSITION.mul(2))).to.be.revertedWith(
      ...
      describe('negative price market', async () => {
        ...
        context('#openTake', async () => {
          ...
          it('reverts if can liquidate', async () => {
            ...
            await expect(market.connect(user).openTake(POSITION)).to.be.revertedWith(
              'MarketInsufficientCollateralError()',
            )
          })
