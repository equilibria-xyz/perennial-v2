          ...
          context('open', async () => {
            ...
            it('opens the position and settles later with fee', async () => {
              ...
              expectGlobalEq(await market.global(), {
                ...
                oracleFee: MAKER_FEE.div(2).div(10),
          ...
          context('close', async () => {
            ...
            context('settles first', async () => {
              ...
              it('closes the position and settles later with fee', async () => {
                ...
                expectLocalEq(await market.locals(user.address), {
                  currentId: 3,
                  collateral: COLLATERAL.sub(MAKER_FEE).add(MAKER_FEE_WITHOUT_FEE),
                  reward: EXPECTED_REWARD.mul(3),
                  protection: 0,
                })
                expectPositionEq(await market.positions(user.address), {
                ...
                expectGlobalEq(await market.global(), {
                  ...
                  oracleFee: MAKER_FEE_FEE.div(2).div(10),
        ...
        context('invalid oracle version', async () => {
          ...
          it('settles valid version after', async () => {
            ...
            expectGlobalEq(await market.global(), {
              ...
              oracleFee: TAKER_FEE_FEE.div(2).div(10),
          ...
          it('settles invalid then valid version at once', async () => {
            ...
            expectLocalEq(await market.locals(user.address), {
              currentId: 3,
              collateral: COLLATERAL, // does not charge fee if both were pending at once
              reward: 0,
              protection: 0,
            })
            expectPositionEq(await market.positions(user.address), {
