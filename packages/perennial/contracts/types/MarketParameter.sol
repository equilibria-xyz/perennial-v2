...
library MarketParameterStorageLib {
    ...
    function read(MarketParameterStorage storage self) internal view returns (MarketParameter memory) {
        ...
        (bool closed, bool settle) = (flags & 0x04 == 0x04, flags & 0x08 == 0x08);
    ...
    function _store(MarketParameterStorage storage self, MarketParameter memory newValue) private {
        uint256 flags = (newValue.closed ? 0x04 : 0x00) | (newValue.settle ? 0x08 : 0x00);

        uint256 encoded0 = uint256(UFixed6.unwrap(newValue.fundingFee) << (256 - 24)) >> (256 - 24)
            ...
            | uint256(UFixed6.unwrap(newValue.maxPriceDeviation) << (256 - 24))
                >> (256 - 24 - 24 - 24 - 24 - 24 - 16 - 16 - 24)
