...
interface IMarket is IInstance {
    ...
    event AccountPositionProcessed(address indexed account, uint256 indexed fromOracleVersion, uint256 indexed toOracleVersion, uint256 fromPosition, uint256 toPosition, Fixed6 collateralAmount, Fixed6 positionFee, UFixed6 keeperFee);
