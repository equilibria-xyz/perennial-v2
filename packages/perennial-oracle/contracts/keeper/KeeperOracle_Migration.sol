...
contract KeeperOracle_Migration is KeeperOracle {
    ...
    function at(
        uint256 timestamp
    ) public pure override returns (OracleVersion memory oracleVersion, OracleReceipt memory oracleReceipt) {
    ...
    function localCallbacks(uint256) external pure override returns (address[] memory) {
        revert NotImplementedError();
    }

    function next() public pure override returns (uint256) {
        revert NotImplementedError();
    }

    function responses(uint256) external pure override returns (PriceResponse memory) {
        revert NotImplementedError();
    }

    function request(IMarket, address) external pure override {
        revert NotImplementedError();
    }

    function status() external pure override returns (OracleVersion memory, uint256) {
        revert NotImplementedError();
    }

    function latest() public pure override returns (OracleVersion memory) {
        revert NotImplementedError();
    }

    function current() public pure override returns (uint256) {
        revert NotImplementedError();
    }

    function commit(OracleVersion memory, address, uint256) external pure override {
        revert NotImplementedError();
    }

    function settle(uint256, uint256, address) external pure override {
        revert NotImplementedError();
    }
}
