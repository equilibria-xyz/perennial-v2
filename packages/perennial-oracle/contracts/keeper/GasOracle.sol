...
/// @title GasOracle
/// @notice Standalone gas oracle for externally computing keeper rewards
abstract contract GasOracle {
    ...
    /// @notice Chainlink ETH-Token feed, where Token is the underlying token of the market, or one with equivalent value
