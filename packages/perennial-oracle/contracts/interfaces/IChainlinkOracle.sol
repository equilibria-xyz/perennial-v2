...
interface IChainlinkOracle is IOracleProvider, IInstance, IKept {
    struct Global {
    ...
    // sig: 0xfd13d773
    error ChainlinkOracleInvalidPriceIdError(bytes32 id);
    // sig: 0x9b4e67d3
    error ChainlinkOracleVersionOutsideRangeError();
