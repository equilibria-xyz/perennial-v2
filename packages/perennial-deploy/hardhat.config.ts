...
const config = defaultConfig({
  dependencyPaths: [
    ...
    '@equilibria/perennial-v2-oracle/contracts/chainlink/ChainlinkFactory_Arbitrum.sol',
    '@equilibria/perennial-v2-oracle/contracts/chainlink/ChainlinkFactory_Optimism.sol',
