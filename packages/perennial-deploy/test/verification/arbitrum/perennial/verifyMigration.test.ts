...
describe('Verify Markets Migration', () => {
  ...
  it('Market: ETH', async () => {
    ...
    expect(parameter.makerRewardRate).to.equal(parameterBefore.makerRewardRate)
    expect(parameter.longRewardRate).to.equal(parameterBefore.longRewardRate)
    expect(parameter.shortRewardRate).to.equal(parameterBefore.shortRewardRate)
    ...
    expect(riskParameter.takerSkewFee).to.equal(riskParameterBefore.takerSkewFee)
    expect(riskParameter.takerImpactFee).to.equal(riskParameterBefore.takerImpactFee)
    expect(riskParameter.makerFee).to.equal(riskParameterBefore.makerFee)
    expect(riskParameter.makerImpactFee).to.equal(riskParameterBefore.makerImpactFee)
    ...
    expect(versionLatest.makerReward._value).to.equal(versionLatestBefore.makerReward._value)
    expect(versionLatest.longReward._value).to.equal(versionLatestBefore.longReward._value)
    expect(versionLatest.shortReward._value).to.equal(versionLatestBefore.shortReward._value)
    ...
    expect(versionPending.makerReward._value).to.equal(versionPendingBefore.makerReward._value)
    expect(versionPending.longReward._value).to.equal(versionPendingBefore.longReward._value)
    expect(versionPending.shortReward._value).to.equal(versionLatestBefore.shortReward._value)
  })
})
