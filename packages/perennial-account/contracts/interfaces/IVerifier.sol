...
import { UpdateSigner } from "../types/UpdateSigner.sol";
...
interface IVerifier is IVerifierBase {
    ...
    function verifyUpdateSigner(UpdateSigner calldata updateSigner, bytes calldata signature) external returns (address);
}
